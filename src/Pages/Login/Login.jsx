...
<div className="divider">Or</div>
      <form action="" className="mt-6">
        <label className="font-semibold text-gray-dark block pb-2">Email</label>
        <input
          type="email"
        ...
        <input
          ...
          className="input w-full  focus:outline-none border-gray rounded-xl"
        />
        <button className="w-full my-5 text-center py-1 text-white px-6 bg-gradient-to-r from-second to-main">Log In</button>
      </form>
      <p className="text-sm text-center py-4">Don't have an account?
<Link to="/signup" className="text-second">Sign up</Link></p>
     </div>
    </div>
  );
};
